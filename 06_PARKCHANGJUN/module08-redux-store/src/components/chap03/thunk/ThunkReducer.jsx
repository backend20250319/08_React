...
/*
  reducers : 이 슬라이스 자체에서 정의하고 직접적으로 관련된 동기적인 액션들을 위한 리듀서 로직  
  extraReducers: 외부에서 발생한 액션에 반응하는 리듀서 조직을 정의할 때 사용
*/
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    /*
      builder 객체에는 addCase등의 메소드가 있어서, 어떤 액션 타입에 반응할지 그리고
      어떤 리듀스 로직을 실행할지를 체인 형태로 연결하며 정의할 수 있다.
    */
    builder
